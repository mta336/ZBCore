...
import com.litgames.gameobjects.Grass;
import com.litgames.gameobjects.Pipe;
...
public class GameRenderer {
	...
	public GameRenderer(GameWorld world, int gameHeight, int midPointY) {
		...
		// We are setting the instance variables' value to be that of the
		// paramaters passed in from GameScreen.
